                                ...
                                <tr
                                    ...
                                    <td class="px-2 py-4 text-center">
                                        <span
                                            ...
                                            <?php echo e(number_format($sale['new']['qty'])); ?>

                                        </span>
                                    </td>
                                    <td class="px-2 py-4 text-center text-green-700 font-semibold">
                                        <?php echo e(number_format($sale['new']['revenue'], 2)); ?>

                                    </td>
                                    <td class="px-2 py-4 text-center border-l border-gray-300">
                                        <?php echo e(number_format($sale['new']['orders'])); ?>
                                    ...
                                    <td class="px-2 py-4 text-center">
                                        <span
                                            ...
                                            <?php echo e(number_format($sale['used']['qty'])); ?>

                                        </span>
                                    </td>
                                    <td class="px-2 py-4 text-center text-green-700 font-semibold">
                                        <?php echo e(number_format($sale['used']['revenue'], 2)); ?>

                                    </td>
                                    <td class="px-2 py-4 text-center border-l border-gray-300">
                                        <?php echo e(number_format($sale['used']['orders'])); ?>

                                    </td>

                                    <!-- Totals -->
                                    <td class="px-2 py-4 text-center bg-blue-50 font-bold">
                                        <?php echo e(number_format($totalQty)); ?>
                        ...
                        <tfoot class="bg-gray-100 font-bold">
                            <tr>
                                ...
                                <td class="px-2 py-4 text-center bg-blue-100 text-blue-900">
                                    <?php echo e(number_format($grandTotalNewQty)); ?>

                                </td>
                                <td class="px-2 py-4 text-center bg-blue-100 text-green-800">
                                    <?php echo e(number_format($grandTotalNewRevenue, 2)); ?>

                                </td>
                                <td class="px-2 py-4 text-center bg-blue-100 border-l border-gray-400">
                                    <?php echo e(number_format($grandTotalNewOrders)); ?>

                                </td>
                                <td class="px-2 py-4 text-center bg-orange-100 text-orange-900">
                                    <?php echo e(number_format($grandTotalUsedQty)); ?>

                                </td>
                                <td class="px-2 py-4 text-center bg-orange-100 text-green-800">
                                    <?php echo e(number_format($grandTotalUsedRevenue, 2)); ?>

                                </td>
                                <td class="px-2 py-4 text-center bg-orange-100 border-l border-gray-400">
                                    <?php echo e(number_format($grandTotalUsedOrders)); ?>

                                </td>
                                <td class="px-2 py-4 text-center bg-gray-200 text-gray-900">
                                    <?php echo e(number_format($grandTotalNewQty + $grandTotalUsedQty)); ?>

                                </td>
                                <td class="px-2 py-4 text-center bg-gray-200 text-green-900">
                                    <?php echo e(number_format($grandTotalNewRevenue + $grandTotalUsedRevenue, 2)); ?>

                                </td>
                                <td class="px-2 py-4 text-center bg-gray-200 text-gray-900">
                                    <?php echo e(number_format($grandTotalNewOrders + $grandTotalUsedOrders)); ?>
...
<?php endif; ?><?php /**PATH /Users/mac/Herd/MohamedHashim/resources/views/filament/resources/product-resource/pages/sales-by-condition-report.blade.php ENDPATH**/ ?>