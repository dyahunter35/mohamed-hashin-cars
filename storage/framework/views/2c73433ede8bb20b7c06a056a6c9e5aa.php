            ...
            <div class="text-center pt-4">
                <a class="text-primary-600"
                   ...
                   onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                    <?php echo e(__('filament-lockscreen::default.button.switch_account')); ?>
...
<?php /**PATH /Users/mac/Herd/MohamedHashim/resources/views/vendor/filament-lockscreen/page/auth/login.blade.php ENDPATH**/ ?>