...
return [
    ...
    'reports' => [
        'sales_by_condition' => [
            'label' => 'تقرير المبيعات حسب الحالة',
            'model_label' => 'تقرير المبيعات حسب الحالة',
            'navigation' => [
                'group' => 'التقارير',
                'label' => 'تقرير المبيعات حسب الحالة',
                'plural_label' => 'تقارير المبيعات حسب الحالة',
            ],
        ],
        'sales_and_payments' => [
            'label' => 'تقرير المبيعات والتحصيل',
            'model_label' => 'تقرير المبيعات والتحصيل',
            'navigation' => [
                'group' => 'التقارير',
                'label' => 'تقرير المبيعات والتحصيل',
                'plural_label' => 'تقارير المبيعات والتحصيل',
            ],
            'filters' => [
                'payment_status' => [
                    'label' => 'حالة الدفع',
