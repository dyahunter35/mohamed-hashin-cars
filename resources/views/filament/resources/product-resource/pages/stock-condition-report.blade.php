<x-filament-panels::page>
    ...
    <div class="text-gray-800">
        ...
        <!-- Main Container -->
        <div id="report-content" class="space-y-1 print:m-0 w-full h-full">

            <main class="w-full max-w-7xl mx-auto p-4 sm:p-6 md:p-8 m-4">
                            ...
                            <tfoot class="bg-gray-100 font-bold">
                                <tr>
                                    ...
                                    @foreach ($branches as $branch)
                                        ...
                                        @endphp
                                        <td
                                            class="px-2 py-4 text-center border-l border-gray-300 bg-blue-100 text-blue-900">
    ...
    <style>
        /* لضمان عدم ظهور الأزرار أثناء الطباعة */
        @media print {
            .no-print {
            ...
            #report-content {
                position: static;
                z-index: 1;
                /* تغيير من absolute لضمان ثبات التنسيق في الجداول الطويلة */
                width: 100%;
            }
        }

        /* تحسين مظهر التمرير لضمان عدم تداخل الجدول مع الأزرار */
        .overflow-x-auto {
