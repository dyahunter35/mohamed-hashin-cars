<x-filament-panels::page>
    ...
    <div class="text-gray-800">
        ...
        <main class="w-full max-w-7xl mx-auto p-4" >
            ...
            <div class="bg-white shadow-sm rounded-xl border border-gray-200 dark:bg-gray-900 dark:border-white/10 mb-6">
                <div class="flex justify-between gap-4 p-6">
                    <div
                        class="w-full bg-red-50 p-4 rounded-lg border border-red-100 dark:bg-red-950/20 dark:border-red-900/50">
                        <p class="text-sm font-medium text-red-800 dark:text-red-300">حالات حرجة (أقل من نصف حد الأمان)
                        </p>
                        <p class="text-3xl font-bold text-red-900 dark:text-white">{{ $urgentCount }}</p>
                    </div>
                    <div
                        class="w-full bg-amber-50 p-4 rounded-lg border border-amber-100 dark:bg-amber-950/20 dark:border-amber-900/50">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-right divide-y divide-gray-200 dark:divide-white/5">
                        <thead class="bg-gray-50 dark:bg-white/5">
                            <tr>
                                <th class="px-6 py-4 text-xs font-bold text-gray-500 uppercase dark:text-gray-400">
                                    المنتج</th>
                                <th class="px-6 py-4 text-xs font-bold text-gray-500 uppercase dark:text-gray-400">الفرع
                                </th>
                                <th
                                    class="px-6 py-4 text-center text-xs font-bold text-gray-500 uppercase dark:text-gray-400">
                                    حد الأمان</th>
                                <th
                                    class="px-6 py-4 text-center text-xs font-bold text-gray-500 uppercase dark:text-gray-400">
                                    الكمية الحالية</th>
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-white/5">
                            @foreach($allLowStock as $item)
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-white/5">
                                    ...
                                    <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-400">{{ $item->branch_name }}
                                    </td>
            ...
            <div class="mt-6">
                @livewire(\App\Filament\Resources\ProductResource\Widgets\LowStockAlerts::class,[])
            </div>
        </main>
        </div>
